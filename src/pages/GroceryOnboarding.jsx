...
export default function GroceryOnboarding({ onComplete }) {
  ...
  const validateStep = () => {
    if (step === 1) return formData.storeName && formData.category && formData.businessType;
    ...
    if (step < steps.length) {
      ...
      try {
        const payload = {
          ...
          cuisine_type: formData.category, // Stored in DB under cuisine_type for now
          lat: position.lat,
          lon: position.lng,
      ...
      <div className="reg-container" style={{maxWidth: '800px', margin: '40px auto'}}>
        <div className="reg-header">
          <motion.h1 initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
            Complete Your Grocery Store Profile
          </motion.h1>
            ...
            {step === 1 && (
              <motion.div key="step1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                <div className="step-header">
                  <h2>Store Details</h2>
                  <p>Basic information about your grocery store</p>
                </div>
                <div className="form-grid">
                  <div className="form-group full-width">
                    <label>Store Name <span>*</span></label>
                    <input type="text" name="storeName" className="form-control" value={formData.storeName} onChange={handleChange} placeholder="e.g. Fresh Mart" />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <select name="businessType" className="form-control" value={formData.businessType} onChange={handleChange}>
                      <option value="Grocery Vendor">Grocery Vendor</option>
            ...
            {step === 2 && (
              <motion.div key="step2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                <div className="step-header">
                  ...
                  <p>Click on the map to pin your exact store location for drivers.</p>
                </div>
